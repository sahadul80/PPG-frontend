        ...
        <div className="mx-auto max-w-screen-xl px-4 py-8 sm:px-6 sm:py-12 lg:px-8">
            ...
            <dl className="mt-6 grid grid-cols-1 gap-4 sm:mt-8 sm:grid-cols-2 lg:grid-cols-4">
                <div className="flex flex-col rounded-lg bg-blue-50 px-4 py-8 text-center">
                    <dt className="order-last text-lg font-medium">Visa Categories</dt>
                    
                    <dd className="flex justify-center text-4xl font-extrabold md:text-5xl">
                        <svg
                ...
                <div className="flex flex-col rounded-lg bg-blue-50 px-4 py-8 text-center">
                    <dt className="order-last text-lg font-medium">Team Members</dt>
                ...
                <div className="flex flex-col rounded-lg bg-blue-50 px-4 py-8 text-center">
                    <dt className="order-last text-lg font-medium">Visa Processed</dt>
                ...
                <div className="flex flex-col rounded-lg bg-blue-50 px-4 py-8 text-center">
                    <dt className="order-last text-lg font-medium">Succes Rate</dt>

                    <dd className="flex justify-center text-4xl font-extrabold md:text-5xl">
                        <svg
                            xmlns="http://www.w3.org/2000/svg"
                            viewBox="0 -72 780 780"
                            style={{ width: "4rem", height: "4rem" }}
                            fill="currentColor"
                        >
