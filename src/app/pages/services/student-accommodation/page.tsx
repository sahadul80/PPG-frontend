            ...
            <div className="container mx-auto px-2 py-2">
                <div className="flex flex-col md:flex-row gap-6">
                    <div className="md:w-2/3 p-6">
                        <h1 className="text-2xl font-bold mb-4">Student Accommodation in the UK</h1>
                        <p className="mb-4">
                        ...
                        <h2 className="text-xl font-bold text-blue-700 mb-2">Types of Student Accommodations in the UK</h2>
                        ...
                        <h2 className="text-xl font-bold text-blue-700 mb-2">How Much is UK Student Accommodation?</h2>
                        <p className="mb-4">
                        ...
                        <h2 className="text-xl font-bold text-blue-700 mb-2">Student Accommodation Locations</h2>
                        <p className="mb-4">
